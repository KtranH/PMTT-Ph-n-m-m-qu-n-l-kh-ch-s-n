                                ...
                                <form action="{{ route("addreview") }}" method="POST">
                                    ...
                                    <div style="display:flex; justify-content: space-around;margin-bottom: 20px;">
                                        ...
                                        <div class="col-md-8 col-lg-12">
                                            <input name="roomname" type="text" class="form-control" id="fullName" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;" value="{{ $phong->TENPHONG }}" readonly disabled>
                                        </div>
                                        </div>
                                        <div style="width:100%">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label"  style="font-weight:bold">Loại phòng bạn đã đặt:</label>
                                            <div class="col-md-8 col-lg-12">
                                                <input name="catename" type="text" class="form-control" id="fullName" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;" value="{{ $phong->loaiPhong->TENLOAIPHONG }}" readonly disabled>
                                            </div>
                                        </div>
                                    </div>  
                                    <div style="display:flex; justify-content: space-around;margin-bottom: 20px;">
                                        ...
                                        <div class="col-md-8 col-lg-12">
                                            <input name="star" type="number" min="1" max="5" class="form-control" id="fullName" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;" required>
