                                ...
                                <div class="col-12" data-aos="fade-right">
                                    <div class="card" style="border-radius:20px">
                                        ...
                                        ">
                                                ...
                                                <label for="occupant_info" class="block text-sm font-medium text-gray-700 mb-2 mt-4">
                                                    Thông tin người sẽ lưu trú (không bắt buộc):
                                                </label>
                                                <input 
                                                        type="text" 
                                                        id="occupant_info" 
                                                        placeholder="Trần Văn A - 123456789" 
                                                        class="flex-1 block w-[100%] px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                                        style="border-radius:20px"
                                                    >
                                                    <p style="font-size: 12px; color:rgba(0, 0, 0, 0.24); margin-top: 10px">(Lưu ý thông tin phải thật chính xác để có thể nhận được phòng. Nếu có sai sót chúng tôi sẽ chấp nhận thông tin của người đặt phòng)</p>
                                            </div>
                                        </div>
                                                            ...
                                                            $(document).ready(function() {
                                                                $('.confirm-button').click(function(e) {
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        var occupant_info = $('#occupant_info').val();
