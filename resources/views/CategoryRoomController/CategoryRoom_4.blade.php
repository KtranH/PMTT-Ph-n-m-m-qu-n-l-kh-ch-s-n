@extends('Layout')
@section('body')
<title>GTX - Loại phòng 4 người</title>
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Loại phòng 4 người</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                    ...
                    <div class="col-12">
                        <div class="card" style="border-radius:20px">
                            <div class="card-body">
                                ...
                                @endif
                                @endforeach
                                {{ $categoryroom_4->links("vendor.pagination.bootstrap-5") }}
                              </div>
                            </div>
                        </div>
