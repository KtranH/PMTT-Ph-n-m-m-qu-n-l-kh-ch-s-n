@extends('Layout')
@section('body')
<title>GTX - Loại phòng 2 người</title>
<main id="main" class="main">

    <div class="pagetitle">
        <h1>Loại phòng 2 người</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route("Home") }}">GTX</a></li>
                <li class="breadcrumb-item active">Loại phòng 2 người</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
             ...
             <!-- Reports -->
                    <div class="col-12">
                        <div class="card" style="border-radius:20px">
                            <div class="card-body">
                                <h5 class="card-title">Loại phòng <span>/Loại 2 người</span></h5>
