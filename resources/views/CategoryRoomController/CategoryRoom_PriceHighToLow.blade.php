@extends('Layout')
@section('body')
<title>GTX - Phân loại từ giá cao tới thấp</title>
                    ...
                    <div class="col-12">
                        <div class="card" style="border-radius:20px">
                            <div class="card-body">
                                ...
                                @endforeach
                                {{ $categoryroom_price_hightolow->links("vendor.pagination.bootstrap-5") }}
                              </div>
                            </div>
                        </div>
