@extends('Layout')
@section('body')
<title>GTX - Loại phòng từ giá thấp tới cao</title>
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Phân theo giá phòng</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                    ...
                    <div class="col-12">
                        <div class="card" style="border-radius:20px">
                            <div class="card-body">
                                ...
                                @endif
                                @endforeach
                                {{ $categoryroom_price_lowtohigh->links("vendor.pagination.bootstrap-5") }}
                              </div>
                            </div>
                        </div>
